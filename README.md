<p align="center">
  <img src="./assets/profile-console.svg" alt="Nongfsq profile console" width="100%" />
</p>
...
[![Private cockpit](https://img.shields.io/badge/Private%20cockpit-owner%20only-7c2d12?style=for-the-badge&logo=github)](https://github.com/Nongfsq?tab=repositories&q=&type=private&language=&sort=pushed)
...
| [Personal tooling](https://github.com/search?q=user%3ANongfsq+topic%3Apersonal-tooling&type=repositories&s=updated&o=desc) | Codex workflows, bridges, scripts, and repair tools. |
| [Development environment](https://github.com/search?q=user%3ANongfsq+topic%3Adev-environment&type=repositories&s=updated&o=desc) | Editor, terminal, shell, input method, and migration utilities. |
| [Apps](https://github.com/search?q=user%3ANongfsq+topic%3Aapps&type=repositories&s=updated&o=desc) | Web, desktop, dictionary, monitoring, and site projects. |
| [Research and writing](https://github.com/search?q=user%3ANongfsq+topic%3Aresearch-writing&type=repositories&s=updated&o=desc) | Archive, EPUB, translation, and structured note systems. |

> Private search results only appear when I am logged in. Public visitors see the public subset.

## Active Launchpad

| Track | Primary route | Stack |
| --- | --- | --- |
| **Omenpin** | [Open by topic](https://github.com/search?q=user%3ANongfsq+topic%3Aomenpin&type=repositories) | TypeScript · private product |
| **Dictionary tools** | [Open app projects](https://github.com/search?q=user%3ANongfsq+topic%3Aapps+dictionary&type=repositories) | TypeScript · Tauri |
...
<p>
  <a href="https://github.com/search?q=user%3ANongfsq+topic%3Aactive&type=repositories"><img alt="active" src="https://img.shields.io/badge/topic-active-0f766e?style=flat-square"></a>
  <a href="https://github.com/search?q=user%3ANongfsq+topic%3Aapps&type=repositories"><img alt="apps" src="https://img.shields.io/badge/topic-apps-2563eb?style=flat-square"></a>
  <a href="https://github.com/search?q=user%3ANongfsq+topic%3Apersonal-tooling&type=repositories"><img alt="personal tooling" src="https://img.shields.io/badge/topic-personal--tooling-4f46e5?style=flat-square"></a>
  <a href="https://github.com/search?q=user%3ANongfsq+topic%3Adev-environment&type=repositories"><img alt="dev environment" src="https://img.shields.io/badge/topic-dev--environment-7c2d12?style=flat-square"></a>
  <a href="https://github.com/search?q=user%3ANongfsq+topic%3Aresearch-writing&type=repositories"><img alt="research writing" src="https://img.shields.io/badge/topic-research--writing-334155?style=flat-square"></a>
  <a href="https://github.com/search?q=user%3ANongfsq+topic%3Alearning&type=repositories"><img alt="learning" src="https://img.shields.io/badge/topic-learning-64748b?style=flat-square"></a>
</p>
...
- Keep private systems quiet until they are ready to be useful.
- Use topics as the remote filing system.
- Prefer small, durable tools that can be reopened months later.
- Make the development environment part of the product surface.

<div align="center">

`quiet software` · `owner cockpit` · `readable systems`
