...
- Use third-party image services only for non-sensitive public stats/cards: `shields.io`, `github-readme-stats`, and `readme-typing-svg`.
...
- `PROFILE-005`: Add dynamic visuals through third-party image services without private tokens.
